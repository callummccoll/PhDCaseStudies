    ...
    SnapshotListContainer
{
     ...
     *  state.
     */
    public var transitions: [TimerStateTransition]
    
    public let snapshotSensors: Set<String>?
    
    public let snapshotActuators: Set<String>?

    internal weak var Me: TimerFiniteStateMachine!
     ...
     */
    public init(_ name: String, transitions: [TimerStateTransition] = [], snapshotSensors: Set<String>?, snapshotActuators: Set<String>?) {
        self.name = name
