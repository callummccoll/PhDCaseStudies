 ...
 */
public final class TimerRinglet: Ringlet, Cloneable, KripkeVariablesModifier {

    internal var Me: TimerFiniteStateMachine!
     ...
     */
    public func execute(state: TimerState) -> TimerState {
    ...
    public func clone() -> TimerRinglet {
        let r = TimerRinglet()
        r.Me = self.Me
        return r
    }
