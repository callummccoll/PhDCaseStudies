 ...
 */
public final class CookingRinglet: Ringlet, Cloneable, KripkeVariablesModifier {

    internal var Me: CookingFiniteStateMachine!
     ...
     */
    public func execute(state: CookingState) -> CookingState {
    ...
    public func clone() -> CookingRinglet {
        let r = CookingRinglet()
        r.Me = self.Me
        return r
    }
