 ...
 */
public final class LightRinglet: Ringlet, Cloneable, KripkeVariablesModifier {

    internal var Me: LightFiniteStateMachine!
     ...
     */
    public func execute(state: LightState) -> LightState {
    ...
    public func clone() -> LightRinglet {
        let r = LightRinglet()
        r.Me = self.Me
        return r
    }
