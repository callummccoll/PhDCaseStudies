    ...
    SnapshotListContainer
{
     ...
     *  state.
     */
    public var transitions: [LightStateTransition]
    
    public let snapshotSensors: Set<String>?
    
    public let snapshotActuators: Set<String>?

    internal weak var Me: LightFiniteStateMachine!
     ...
     */
    public init(_ name: String, transitions: [LightStateTransition] = [], snapshotSensors: Set<String>?, snapshotActuators: Set<String>?) {
        self.name = name
