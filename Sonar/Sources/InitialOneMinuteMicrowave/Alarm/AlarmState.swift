    ...
    SnapshotListContainer
{
     ...
     *  state.
     */
    public var transitions: [AlarmStateTransition]
    
    public let snapshotSensors: Set<String>?
    
    public let snapshotActuators: Set<String>?

    internal weak var Me: AlarmFiniteStateMachine!
     ...
     */
    public init(_ name: String, transitions: [AlarmStateTransition] = [], snapshotSensors: Set<String>?, snapshotActuators: Set<String>?) {
        self.name = name
