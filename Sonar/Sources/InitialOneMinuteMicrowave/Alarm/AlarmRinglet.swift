 ...
 */
public final class AlarmRinglet: Ringlet, Cloneable, KripkeVariablesModifier {

    internal var Me: AlarmFiniteStateMachine!
     ...
     */
    public func execute(state: AlarmState) -> AlarmState {
    ...
    public func clone() -> AlarmRinglet {
        let r = AlarmRinglet()
        r.Me = self.Me
        return r
    }
