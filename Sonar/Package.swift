...
let package = Package(
    ...
    dependencies: [
        ...
        .package(name: "swiftfsm", url: "git@github.com:mipalgu/swiftfsm", .branch("verification")),
        .package(name: "SwiftfsmWBWrappers", url: "https://github.com/mipalgu/SwiftfsmWBWrappers", .branch("verification")),
    ],
    targets: [
