    ...
    SnapshotListContainer
{
     ...
     *  state.
     */
    public var transitions: [CallerStateTransition]
    
    public let snapshotSensors: Set<String>?
    
    public let snapshotActuators: Set<String>?

    internal weak var Me: CallerFiniteStateMachine!
     ...
     */
    public init(_ name: String, transitions: [CallerStateTransition] = [], snapshotSensors: Set<String>?, snapshotActuators: Set<String>?) {
        self.name = name
